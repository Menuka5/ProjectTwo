            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <c:if test="${checkTranslate}">
                        <li class="active"><a id="Translate" href="translate.jsp"><fmt:message key="index.translator"/>
                    ...
                    <c:if test="${checkSearchUser}">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true"
                               aria-expanded="false"><fmt:message key="top.User"/> <fmt:message
                                    key="top.Management"/><span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <c:if test="${checkAddUser}">
                                    <li>
                                        <a href="registration.jsp" id="adduser"><fmt:message key="top.Add"/>
                                            <fmt:message key="top.User"/></a>
                                    </li>
                                </c:if>
                                <li><a href="LoadSearch.jsp" id="searchuser"><fmt:message key="top.Search"/>
                                    <fmt:message key="top.User"/></a></li>
