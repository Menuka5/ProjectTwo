...
frisby.create('Language_List_Receive')
    .get('https://translate.yandex.net/api/v1.5/tr.json/getLangs?key=trnsl.1.1.20160607T111835Z.f64d4276fb712ae3.ed0f150b6046b34df73301472d5e576d32fe3c8b&ui=en')
    .expectStatus(200)
    .expectJSON({
...
frisby.create("Laguage Translation")
    .get("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160607T111835Z.f64d4276fb712ae3.ed0f150b6046b34df73301472d5e576d32fe3c8b&text=eat&lang=en-es")
    .expectStatus(200)
    .expectJSON({
        code: 200,
        lang: "en-es",
